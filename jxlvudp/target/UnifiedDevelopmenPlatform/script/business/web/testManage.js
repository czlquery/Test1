...
function find() {
    jxmstc.findForEasyui("dgTest",getCondition());
}
...
$(function () {
    ...
    jxmstc.browserForEasyui(function (obj) {
        ...
        var toUrl=getRootPath()+"/admin/web/test/test.jsp?type=2&id="+obj.id;
        layer.open({
            title:'测试信息浏览',
            type: 2,
            area:["100%","100%"],
    ...
    jxmstc.editForEasyui(function (obj) {
        var toUrl=getRootPath()+"/admin/web/test/test.jsp?type=1&id="+obj.id;
        layer.open({
            title:'测试信息修改',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnAdd").click(function () {
        var toUrl=getRootPath()+"/admin/web/test/test.jsp?type=0";
        layer.open({
            title:'测试管理新增',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnDeleteAll").click(function () {
        var ids=jxmstc.getEasyuiGridSelectRowsID("dgTest");
        if (ids=="") return;
        var obj=new Object();
        obj.ids=ids;
